...
#' @details The output will be double the amount of layers as in x. The first layers are all the anomalies corresponding to the data points, the following layers are all the probabilities corresponding to the data points
...
#' @param outname Character vector with the output path and filename with extension or only the filename and extension if work directory was set. More information: See writeRaster
#' @param format Character. Output file type. More information: See writeFormats.
#' @details The output will consist of 16 bands: Band1=disturbance detection; Band2=corresponding anomalies band 1; Band3=regrowth detection; Band4=corresponding anomalies band 3; Band5= 2nd disturbance detection for data points that had a previous disturbance and regrowth; Band 6 etc.
#' 
#' @import npphen
#' @import raster
#' @import RColorBrewer
